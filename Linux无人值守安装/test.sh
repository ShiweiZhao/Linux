...
cp /mnt/isolinux/vmlinuz initrd.img boot.msg splash.jpg /var/lib/tftpboot/
...
# Root password
rootpw --iscrypted $1$coF84zg3$Itvqi3t.7K3sd2REPdZaB.
...
setenforce 0
echo "Has httpd is started or not.
[y/N]"
read $YES
if [ $YES = y ] || [ $YES = Y ]
	then exit
